...
.DESCRIPTION
  ...
  The suite this runs loads no poller namespace. Windows has no readiness
  backend until WSAPoll in task W3, so a Windows gate that pulled one in would
  be reporting POSIX behavior.
