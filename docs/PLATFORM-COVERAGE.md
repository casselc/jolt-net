...
- **Windows readiness exists; the Windows wake and close lifecycle does not.**
  ...
  expanded native refusal gate still needs its Windows rerun before W4 branches.
