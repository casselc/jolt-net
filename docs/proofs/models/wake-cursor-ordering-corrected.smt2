...
;
; Domain: one publication, sequence 0 -> 1, one consumer turn. The pre-snapshot
; drain is modelled because it is what actually consumes the byte.
; Expected: unsat for the lost-wake violation.
